...
namespace Testing
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            cpr.Reconcile(@"\\app02\FileShare\Quintillion\Client\share_register_by_lot OEI 23-08-2013.xls", 741, new DateTime(2013, 8, 15));
          ...
          //  nav.GetMatchedNavs(DateTime.Today);
            ...
            service.GetUnmatchedCVLPositions(741, new DateTime(2012, 7, 2), new DateTime(2012, 7, 9), true);
